...
export const chapter10: BaseQuestion[] = [
  {
    ...
    correct: 'Headlights on low beam',
    wrong: ['Headlights off', 'Parking lights on', 'Headlights on high beam'],
    explanation: 'Low beams improve visibility in fog.'
  },
  {
    prompt:
      'Why is driving on an expressway different from driving on an ordinary street?',
    correct: 'You must think faster and handle your vehicle more effectively',
    wrong: [
    ...
    explanation: 'Higher speeds require quicker decisions.'
  },
  {
    prompt:
    ...
    correct: 'Get up to cruising speed gradually so other cars will see you',
    wrong: [
  ...
  },
  {
    ...
    explanation: 'Avoid looking directly at headlights.'
  },
  {
    prompt:
      'If your brake pedal suddenly sinks to the floor, you should first:',
    correct: 'Try to pump it to build up the pressure',
    wrong: [
  ...
  {
    prompt: 'What vehicles must stop at all railroad crossings?',
    correct: 'School buses and passenger buses carrying passengers',
    wrong: ['Pickup trucks', 'Motorcycles', 'Vehicles towing a trailer'],
    explanation: 'Certain vehicles must always stop.'
  },
  {
    prompt:
      'When your right wheels run onto a soft shoulder, what is the best way to get back on the highway?',
    correct: 'Ease your foot off the gas and brake gently',
    wrong: [
  ...
  },
  {
    ...
    explanation: 'Never stop on tracks.'
  },
  {
    prompt: 'If a tire blows out, the proper thing to do is:',
  ...
  {
    prompt: 'Night driving is dangerous because:',
    correct: 'The distance we can see ahead is reduced',
    wrong: [
      'Some traffic signs are less visible at night',
      'More vehicles are on the road at night',
      'Street lights tend to blur our vision'
    ],
    explanation: 'Reduced visibility is the main risk.'
  },
  {
    prompt: (
      <div>
    ...
    explanation: 'Railroad warning sign.'
  },
  {
    prompt:
      'If an approaching train is near enough or going fast enough to be a danger, you must:',
    correct: 'Not cross the tracks until the train has completely passed',
    wrong: [
      'Slow down and proceed with caution',
      'Cross the tracks at your own risk',
      'Find an alternate route across tracks'
    ],
    explanation: 'Never attempt to beat a train.'
  },
  {
    prompt:
      'Expressways have "expressway entrance lanes" (acceleration lanes) so that drivers can:',
    correct: 'Reach the proper speed before blending with traffic',
    wrong: [
  ...
  },
  {
    ...
    explanation: 'Never go around railroad gates.'
  },
  {
    prompt: 'If you drive past your exit on an expressway, you should:',
    correct: 'Drive to the next exit and leave the expressway',
    wrong: [
    ...
    explanation: 'Never reverse on expressway.'
  },
  {
    prompt:
    ...
    correct: 'Slow down and be prepared to stop',
    wrong: [
